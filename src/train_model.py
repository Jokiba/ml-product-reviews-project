...
df = pd.read_csv(r"c:\Users\10\Desktop\ITAcademy\Introduction to Machine Learning using Python\Vežbe\lokalni_repozitorijum\ml-product-reviews-project\data\product_reviews_full.csv")
